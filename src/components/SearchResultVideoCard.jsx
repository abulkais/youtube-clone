        ...
        <Link to={`/video/${video?.videoId}`}>
            <div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4">
                ...
                <div className="flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden">
                    ...
                    <div className="flex text-sm font-semibold text-black/[0.7] truncate overflow-hidden mt-3">
                    ...
                    <div className="hidden md:flex items-center">
                        ...
                        <div className="flex flex-col">
                            <span className="text-sm font-semibold text-black/[0.7] flex items-center">
                                {video?.author?.title}
