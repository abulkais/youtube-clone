                ...
                <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[calc(100%-400px)] px-4 py-3 lg:py-6 overflow-y-auto">
                    ...
                    <div className="flex justify-between flex-col md:flex-row mt-4">
                        <div className="flex">
                            ...
                            <div className="flex items-center justify-center h-11 px-6 rounded-3xl bg-white   ml-5 font-bold hover:bg-[#303030]/[0.15] hover:text-[#000] border border-[#000]">
                               
                                Join
                            </div>

                            <div className="flex items-center justify-center h-11 px-6 rounded-3xl   ml-5 font-bold bg-[#303030]/[0.15] hover:text-[#000] ">
                        ...
                        <div className="flex text-black mt-4 md:mt-0">
                            ...
                            <div className="flex items-center justify-center h-11 px-6 rounded-3xl bg-black/[0.15]  cursor-pointer">
                            ...
                            <div className="flex items-center justify-center h-11 px-6 rounded-3xl bg-black/[0.15] ml-4 cursor-pointer">
